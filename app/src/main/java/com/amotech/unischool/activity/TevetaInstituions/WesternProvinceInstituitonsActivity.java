...
import com.amotech.unischool.activity.TevetaInstituions.WesternProvinceInstituitonsActivity;
...
public class WesternProvinceInstituitonsActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= WesternProvinceInstituitonsActivity.this;
...
// Storing the key and its value as the data fetched from edittext
        ...
        myEdit.commit();
        Intent intent = new Intent(WesternProvinceInstituitonsActivity.this, displayProgramInfoActivity.class);
