...
import com.amotech.unischool.activity.TevetaInstituions.EasternProvinceInstituitonsActivity;
...
public class EasternProvinceInstituitonsActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= EasternProvinceInstituitonsActivity.this;
...
// Storing the key and its value as the data fetched from edittext
        ...
        myEdit.commit();
        Intent intent = new Intent(EasternProvinceInstituitonsActivity.this, displayProgramInfoActivity.class);
