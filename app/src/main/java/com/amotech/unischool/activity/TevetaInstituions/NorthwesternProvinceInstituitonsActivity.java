...
import com.amotech.unischool.activity.TevetaInstituions.NorthwesternProvinceInstituitonsActivity;
...
public class NorthwesternProvinceInstituitonsActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= NorthwesternProvinceInstituitonsActivity.this;
...
// Storing the key and its value as the data fetched from edittext
        ...
        myEdit.commit();
        Intent intent = new Intent(NorthwesternProvinceInstituitonsActivity.this, displayProgramInfoActivity.class);
