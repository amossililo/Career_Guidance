...
/*
        programsList.add(new FacultyData(getString(R.string.testBtn), getString(R.string.additional_info)
                , "https://i.im.ge/2022/09/29/1xzyyz.geology-2.jpg", getString(R.string.testBtnHtml)));
