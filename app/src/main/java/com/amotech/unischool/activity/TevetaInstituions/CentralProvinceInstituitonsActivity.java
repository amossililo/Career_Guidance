...
public class CentralProvinceInstituitonsActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Central Province");;
        setToolbar(toolbar);
        ...
        context= CentralProvinceInstituitonsActivity.this;
...
// Storing the key and its value as the data fetched from edittext
        ...
        myEdit.commit();
        Intent intent = new Intent(CentralProvinceInstituitonsActivity.this, displayProgramInfoActivity.class);
