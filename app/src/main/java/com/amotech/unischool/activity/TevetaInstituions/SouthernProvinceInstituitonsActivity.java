...
import com.amotech.unischool.activity.TevetaInstituions.SouthernProvinceInstituitonsActivity;
...
public class SouthernProvinceInstituitonsActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= SouthernProvinceInstituitonsActivity.this;
...
// Storing the key and its value as the data fetched from edittext
        ...
        myEdit.commit();
        Intent intent = new Intent(SouthernProvinceInstituitonsActivity.this, displayProgramInfoActivity.class);
